...
//     members: VecSet<address>, // Should this be a VecSet<ChannelMemberCap's ID> or plain address ? | enforce a max on the package-level, but allow the configuration of lower number
