...
module dummy_name::api;

use dummy_name::attachment::Attachment;
use dummy_name::channel::{Self, Channel, MemberCap};
use dummy_name::config::Config;
use dummy_name::errors;
use dummy_name::permissions;
...
#[test_only]
use dummy_name::{channel::CreatorCap, attachment, permissions::{Role}};
