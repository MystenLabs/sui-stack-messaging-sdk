...
export const MembershipRegistry = new MoveStruct({
  name: `${$moduleName}::MembershipRegistry`,
  fields: {
    id: object.UID,
  },
});
...
export interface MintAndTransferOptions {
  package?: string;
  arguments: MintAndTransferArguments | [recipient: RawTransactionArgument<string>];
  typeArguments: [string];
}
