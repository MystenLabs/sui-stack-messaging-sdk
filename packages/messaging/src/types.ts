...
export type ParsedCreatorCapObject = (typeof CreatorCap)['$inferType'];
export type ParsedMemberCapObject = (typeof MemberCap)['$inferType'];

export type MemberCapWithOwner = {
	capObject: ParsedMemberCapObject;
	ownerAddress: string | null;
};

export type GeneratedCaps = {
	creatorCap: ParsedCreatorCapObject;
	creatorMemberCap: MemberCapWithOwner;
	additionalMemberCaps: MemberCapWithOwner[];
};
